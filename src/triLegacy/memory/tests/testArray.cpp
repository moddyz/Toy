...
using TestUnifiedTypes     = std::tuple< tri::Array< ValueT, tri::Host >, tri::Array< ValueT, tri::CUDA > >;
using TestIndexAccessTypes = std::tuple< tri::Array< ValueT, tri::Host > >;
...
TEMPLATE_LIST_TEST_CASE( "Array_InitializerListConstructor", "[template][list]", TestUnifiedTypes )
{
    ...
    tri::Array< ValueT, tri::Host > hostArray = array;
