...
/// \file base/bitMask.h
///
/// Macro definitions for simplifying the process the operator overloads for a
/// enum type intended to function as a bit mask.

#define TRI_ENUM_BITMASK_OPERATORS(ENUM_TYPE)                                  \
