...
{
public:
    inline explicit PerspectiveView(float i_verticalFov,
                                    float i_aspectRatio,
      ...
      : m_focalDistance(i_focalDistance)
    {
        ...
        // This is the important trig ratio which will allow us to compute the
        // viewport height from the focal length.
    ...
    {
        return m_focalDistance * gm::Vec3f(0, 0, 1) - (NearHorizontal() * 0.5) -
               (NearVertical() * 0.5);
    }
