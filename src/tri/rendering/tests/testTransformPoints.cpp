...
using PointsTypes = std::tuple< tri::Array< PointsT, tri::Host >, tri::Array< PointsT, tri::CUDA > >;
...
TEMPLATE_LIST_TEST_CASE( "TransformPoints", "[template][list]", PointsTypes )
{
    ...
    TRI_NS::TransformPoints< TestType::ResidencyType >::Execute( transform, inputPoints, outputPoints );
